...
onDrop={handleDrop}
className={`relative border-2 border-dashed rounded-lg p-6 transition-all ${ dragging ? "border-amber-700 bg-amber-50" : file ? "border-emerald-600 bg-emerald-50/40" : "border-stone-300 bg-stone-50/50 hover:border-stone-400" }`}
>
{file ? (
...
<ChevronRight
className={`w-4 h-4 text-stone-400 transition-transform ${ expanded === i ? "rotate-90" : "" }`}
/>
</div>
</button>
{expanded === i && (
...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,700;9..144,800&family=Inter:wght@400;500;600;700&display=swap'); .font-serif { font-family: 'Fraunces', Georgia, serif; }`}</style>
